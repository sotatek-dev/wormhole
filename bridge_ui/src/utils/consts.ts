...
export const KLAYTN_NETWORK_CHAIN_ID = CLUSTER === 'mainnet' ? 8217 : CLUSTER === 'testnet' ? 1001 : 1001;
export const _3RDSIGHT_NETWORK_CHAIN_ID = CLUSTER === 'mainnet' ? 1001 : CLUSTER === 'testnet' ? 221 : 221;
...
export const ETH_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.ETH.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.ETH.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.ETH.DEVNET
);
...
export const ETH_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.ETH_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.ETH_TOKEN.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.ETH_TOKEN.DEVNET
);
export const BSC_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.BSC.DEVNET
);
export const BSC_NFT_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC_NFT.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC_NFT.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.BSC_NFT.DEVNET
);
export const BSC_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.BSC_TOKEN.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.BSC_TOKEN.DEVNET
);
export const POLYGON_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.POLYGON.DEVNET
);
export const POLYGON_NFT_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON_NFT.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON_NFT.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.POLYGON_NFT.DEVNET
);
export const POLYGON_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.POLYGON_TOKEN.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.POLYGON_TOKEN.DEVNET
);
...
export const SOL_BRIDGE_ADDRESS =
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.SOL.DEVNET;
export const SOL_NFT_BRIDGE_ADDRESS =
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL_NFT.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL_NFT.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.SOL_NFT.DEVNET;
export const SOL_TOKEN_BRIDGE_ADDRESS =
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.SOL_TOKEN.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.SOL_TOKEN.DEVNET;
export const ROPSTEN_ETH_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH.DEVNET
);
export const ROPSTEN_ETH_NFT_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH_NFT.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH_NFT.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH_NFT.DEVNET
);
export const ROPSTEN_ETH_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.ROPSTEN_ETH_TOKEN.TESTNET
...
export const KLAYTN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.KLAYTN.DEVNET
);
export const KLAYTN_NFT_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN_NFT.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN_NFT.TESTNET
    : CONTRACT_BRIDGE_ADDRESS.KLAYTN_NFT.DEVNET
);
export const KLAYTN_TOKEN_BRIDGE_ADDRESS = getAddress(
  CLUSTER === "mainnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN_TOKEN.MAINNET
    : CLUSTER === "testnet"
    ? CONTRACT_BRIDGE_ADDRESS.KLAYTN_TOKEN.TESTNET
...
export const WKLAY_ADDRESS =
  CLUSTER === "mainnet"
    ? "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c"
    : CLUSTER === "testnet"
    ? "0xE52b3fCB8aE4E31Cd2Ab416ed52a0c03ea62D6D4"
    : "0xDDb64fE46a91D46ee29420539FC25FD07c5FEa3E";
